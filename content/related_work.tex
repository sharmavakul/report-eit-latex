...
\begin{figure}
    ...
    \caption{AWS Geographical Components}{\cite{99}}
...
\begin{figure}
    ...
    \caption{IAM users and groups}{\cite{100}}
...
\begin{figure}
    ...
    \caption{Overview of AWS IAM concepts}{\cite{101}}
...
AWS
which
allows to rent virtual machine to run computer applications. Amazon EC2 avoids upfront hardware setup investment, enabling faster development and deployment of applications. Amazon EC2 enables launching as few or as many virtual servers as needed, managing storage, and configuring security and networking. Amazon EC2 enables scaling uo or down based on the changes in the requirements or reduction in the need to forecast traffic, and spikes in popularity \cite{27}.
...
\begin{figure}
    ...
    \caption{Amazon Machine Image}{\cite{30}}
    \label{fig:ami}
\end{figure}
...
\begin{figure}
    ...
    \caption{Relational Database Service}{\cite{102}}
    \label{fig:rds}
\end{figure}
...
\begin{figure}
    ...
    \caption{AWS RDS DB Instance Replication}{\cite{103}}
...
\begin{figure}
    ...
    \caption{Amazon Simple Storage Service}{\cite{104}}
    \label{fig:s3}
\end{figure}
...
\begin{longtable}{|p{5cm}|p{11.4cm}|}
    ...
    The persistence of any existing ACLs does not get affected by enabling IgnorePublicAcls, and also it doesn't prevent new public ACLs from being set. \cite{23}.  \\
    \hline
    ...
    All cross account access to the bucket or access point are blocked by RestrictPublicBuckets, while it will still be possible for the users within the account to manage the bucket or access point \cite{23}.  \\
    \hline
