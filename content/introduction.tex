...
The company purchases these IT assets and maintains them within the data centers located on-premises of the company managed by the company.
...
\par \textbf{Chapter 5 (Evaluation)}: In this chapter
several details are discussed such as:
\begin{itemize}
...
\end{itemize}
\par \textbf{Chapter 6 (Conclusion and Future Work)}
concludes this thesis work by summarizing the work done in identifying and assessing the different security vulnerabilities using security assessment tools, results obtained for the assessment, open topics that could not be addressed, and related future work.
