...
\par This section shows the comparison between the assessment performed using Prowler and ScoutSuite against the different security vulnerabilities identified earlier in chapter 3.
Table \ref{tab:comparisionresultprowlervsscoutsuite} shows the comparison result.
