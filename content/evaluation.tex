...
The Password expiration requires an administrator reset, this feature prevents the user from resetting or updating the password for their account after the account password gets expired.
...
The application provides different functions such as
adding, updating and deleting the company's
employees data and information.
...
The assessment report gets generated once the assessment
of the cloud infrastructure against the security
vulnerabilities finishes.
Prowler supports the generation of assessment reports in
multiple formats such as text, JUnit-XML, etc.
The
generated assessment report provides a detailed description of the security vulnerability assessed, check in Prowler that assesses the security vulnerability, the result of the assessment, region, associated AWS service, etc. \cite{49}.
...
\begin{itemize}
    \item Prowler was able to perform the assessment of
...
use Prowler and ScoutSuite as the assessment tools to
perform the assessment of the enterprise cloud
infrastructure.
